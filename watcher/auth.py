...
try:
    ...
    print("[OAUTH] python-dotenv not installed, using environment variables only")
...
if not CLIENT_ID or not CLIENT_SECRET or not CLIENT_ID.strip() or not CLIENT_SECRET.strip():
    print("[OAUTH] GitHub OAuth not configured (optional). Skipping...")
    print("[OAUTH] To enable auto-deploy, add GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET to .env")
else:
